...
public class IqaKnowledgeController{
	 ...
	 * @param modelMap spring的mvc返回对象
	 ***/
	@RequestMapping(value="/to_select_category_tree")
	public String ToSelectCategoryTree(HttpServletRequest request,  ModelMap modelMap) {
		modelMap.addAttribute("prefix",prefix);
		return prefix+"/category_tree";
	}
	/**
	 *跳转到未知知识库页面
	 *@param request 请求对象
